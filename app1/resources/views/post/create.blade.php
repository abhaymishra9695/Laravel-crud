...
<body>
    <div class="row">
        ...
        @endif
        <form method="post" id="form" action="{{ route('posts.store')}}" style="margin-top:35px">
           @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <textarea name="discription"  class="form-control" id="description" placeholder="Description">{{ old('description') }}</textarea>
